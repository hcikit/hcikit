...
type MappedPartial<T extends Record<string, Record<string, unknown>>> = Partial<{[Key in keyof T] : Partial<T[Key]>}>

export type Configuration<T extends Record<string, Record<string, unknown>> = Record<string, Record<string, unknown>>> = 
